...
public class PrefabCombiner : MonoBehaviour
{
    ...
    public static void CombinePrefabs(GameObject prefabA, GameObject prefabB)
    {
        ...
        if (prefabALevel != null && prefabBLevel != null && rbA != null && rbB != null && prefabALevel.level == prefabBLevel.level && prefabALevel.level != 7 && prefabALevel.level != 13 && prefabALevel.level != 25)
        {
